    ...
    <div class="w-full h-full space-y-6">
        <PageContainer>
            <UCard class="w-full h-full space-y-6">
                <div class="text-gray-800 px-8 h-φθλλ">
                    <div ref="htmlContent">
                        ...
                        <div class="prose lg:prose-sm prose-h2:text-center max-w-full">
                            ...
                            <p>
                                ...
                                contains, being "<span class="italic">{{ title }}</span
                            ...
                            <p>
                                ...
                                {{ isExclusive }}, {{ region }}, {{ transferable }},
                                {{ dayjs(termDate).format('DD MMMM YYYY') }}
                            ...
                            <ul>
                                ...
                                <li v-if="extraTerms">{{ extraTerms }}</li>
                            </ul>
                            ...
                            <p>
                                ...
                                <span v-if="additionalRenewalTerms"
                                    >for an additional term of {{ additionalRenewalTerms }}</span
                                >
                                unless either Party provides the other with written notice not to renew at least
                                {{ nonRenewalDays }} days prior to the expiration date of the current term.
                            </p>
                            <p>
                                ...
                                cured within
                                {{ contractBreachDays }} days after being notified of the breach. Furthermore, the Data
                                Provider may terminate the data-sharing arrangement or provision of the Data Set on the
                                PISTIS Data Marketplace upon reasonable prior written notice to the Data Recipient if
                                the Data Provider’s rights to material portions of the Data Set or data involved in the
                                Data Set becomes unavailable provided that the Data Provider shall provide a pro-rated
                                refund to Data Recipient for the remainder of the then-current term.
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                <!--OPTION  1-->
                                <span v-if="type === 'one-off'"
                                    >The Parties agree on that the Data Recipient shall pay the Data Provider
                                    {{ price }} STC (‘Fee’) for the license to access, copy and process the Data Set as
                                    defined herein on the Effective date. The Fee is exclusive of VAT or local sales tax
                                    or any other applicable taxes.</span
                                >

                                <!-- OPTION 2 -->
                                <span v-if="type === 'subscription'">
                                    The Parties agree on that Data Recipient shall pay Data Provider
                                    {{ price }} STC (‘Subscription Fee’) on a(n) {{ subscriptionFrequency }} basis, in
                                    advance, starting from the Effective Date and recurring on the same date of every
                                    following {{ recurrentPaymentText }}, for the license to access, copy and process
                                    the Data Set as defined herein during the term of the data-sharing agreement.
                                    <span v-if="subscriptionFrequency === 'monthly'"
                            ...
                            <p>
                                ...
                                <span v-if="!personalDataTerms"> The Data Set does not include personal data. </span>
                                <span v-else>
                                    The Data Set includes personal data, and the related data processing is subject to
                                    the following: {{ personalDataTerms }}
                                </span>
                            </p>
                            <p>
